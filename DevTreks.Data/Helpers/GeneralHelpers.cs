...
namespace DevTreks.Data.Helpers
{
    ...
    public static class GeneralHelpers
    {
            ...
            string fileExtension)
        {
            ...
            //{networkname}
            oStrBldr.Append(networkName.ToLower());
            oStrBldr.Append(WEBFILE_PATH_DELIMITER);
            oStrBldr.Append(currentNodeName.ToLower());
            oStrBldr.Append(WEBFILE_PATH_DELIMITER);
            ...
            oStrBldr.Append(WEBFILE_PATH_DELIMITER);
            oStrBldr.Append(fileExtension.ToLower());
            ...
            string variable)
        {
                ...
                && subActionType != SERVER_SUBACTION_TYPES.none.ToString())
            {
                ...
                bldr.Append(WEBFILE_PATH_DELIMITER);
                bldr.Append(subActionType.ToString().ToLower());
                bldr.Append(WEBFILE_PATH_DELIMITER);
                bldr.Append(subActionView.ToLower());
                bldr.Append(WEBFILE_PATH_DELIMITER);
            ...
            string subActionView, string variable)
        {
            ...
            {
                StringBuilder bldr = new StringBuilder();
                bldr.Append(controller.ToLower());
                bldr.Append(WEBFILE_PATH_DELIMITER);
