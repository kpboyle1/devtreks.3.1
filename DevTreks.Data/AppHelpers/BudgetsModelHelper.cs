        ...
        public async Task<bool> SetURIBudgets(ContentURI uri, bool saveInFileSystemContent)
        {
            ...
            if (uri.URINodeName == Agreement.AGREEMENT_BASE_TYPES.servicebase.ToString())
            {
                ...
                if (s != null)
                {
                    ...
                    if (qry != null)
                    {
                        s.BudgetSystem = await qry.ToListAsync();
            ...
            else if (uri.URINodeName == Economics1.BUDGET_TYPES.budgetgroup.ToString())
            {
                ...
                if (rc != null)
                {
                    ...
                    if (qry != null)
                    {
                        rc.BudgetSystemToEnterprise = await qry.ToListAsync();
                ...
                == Economics1.BUDGET_TYPES.budget.ToString())
            {
                ...
                if (rp != null)
                {
                    ...
                    if (qry != null)
                    {
                        rp.BudgetSystemToTime = await qry.ToListAsync();
                ...
                == Economics1.BUDGET_TYPES.budgettimeperiod.ToString())
            {
                ...
                if (rp != null)
                {
                    ...
                    if (qry != null)
                    {
                        rp.BudgetSystemToOutcome = await qry.ToListAsync();
                    ...
                    if (qry2 != null)
                    {
                        rp.BudgetSystemToOperation = await qry2.ToListAsync();
                ...
                == Economics1.BUDGET_TYPES.budgetoperation.ToString())
            {
                ...
                if (rp != null)
                {
                    ...
                    if (qry != null)
                    {
                        rp.BudgetSystemToInput = await qry.ToListAsync();
                ...
                == Economics1.BUDGET_TYPES.budgetoutcome.ToString())
            {
                ...
                if (rp != null)
                {
                    ...
                    if (qry != null)
                    {
                        rp.BudgetSystemToOutput = await qry.ToListAsync();
