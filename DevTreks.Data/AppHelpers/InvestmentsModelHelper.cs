        ...
        public async Task<bool> SetURIInvestments(ContentURI uri, bool saveInFileSystemContent)
        {
                ...
                == Agreement.AGREEMENT_BASE_TYPES.servicebase.ToString())
            {
                ...
                if (s != null)
                {
                    ...
                    if (qry != null)
                    {
                        s.CostSystem = await qry.ToListAsync();
                ...
                == Economics1.INVESTMENT_TYPES.investmentgroup.ToString())
            {
                ...
                if (rc != null)
                {
                    ...
                    if (qry != null)
                    {
                        rc.CostSystemToPractice = await qry.ToListAsync();
                ...
                == Economics1.INVESTMENT_TYPES.investment.ToString())
            {
                ...
                if (rp != null)
                {
                    ...
                    if (qry != null)
                    {
                        rp.CostSystemToTime = await qry.ToListAsync();
                ...
                == Economics1.INVESTMENT_TYPES.investmenttimeperiod.ToString())
            {
                ...
                if (rp != null)
                {
                    ...
                    if (qry != null)
                    {
                        rp.CostSystemToOutcome = await qry.ToListAsync();
                    ...
                    if (qry2 != null)
                    {
                        rp.CostSystemToComponent = await qry2.ToListAsync();
                ...
                == Economics1.INVESTMENT_TYPES.investmentcomponent.ToString())
            {
                ...
                if (rp != null)
                {
                    ...
                    if (qry != null)
                    {
                        rp.CostSystemToInput = await qry.ToListAsync();
                ...
                == Economics1.INVESTMENT_TYPES.investmentoutcome.ToString())
            {
                ...
                if (rp != null)
                {
                    ...
                    if (qry != null)
                    {
                        rp.CostSystemToOutput = await qry.ToListAsync();
