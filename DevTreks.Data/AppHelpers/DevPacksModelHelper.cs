            ...
            bool saveInFileSystemContent)
        {
            ...
            if (uri.URINodeName == Agreement.AGREEMENT_BASE_TYPES.servicebase.ToString())
            {
                ...
                if (s != null)
                {
                    ...
                    if (qry != null)
                    {
                        s.DevPackClass = await qry.ToListAsync();
            ...
            else if (uri.URINodeName == DevPacks.DEVPACKS_TYPES.devpackgroup.ToString())
            {
                ...
                if (rc != null)
                {
                    ...
                    if (qry != null)
                    {
                        rc.DevPackClassToDevPack = await qry.ToListAsync();
                ...
                == DevPacks.DEVPACKS_TYPES.devpack.ToString())
            {
                ...
                if (rp != null)
                {
                    ...
                    if (qry != null)
                    {
                        rp.DevPackClassToDevPack1 = await qry.ToListAsync();
                    ...
                    if (qry2 != null)
                    {
                        rp.DevPackToDevPackPart = await qry2.ToListAsync();
                ...
                == DevPacks.DEVPACKS_TYPES.devpackpart.ToString())
            {
                ...
                if (r != null)
                {
                    ...
                    if (qry != null)
                    {
                        r.DevPackPartToResourcePack = await qry.ToListAsync();
