...
namespace DevTreks.Extensions
{
    ...
    public class ME2Indicator : CostBenefitCalculator
    {
        ...
        public async Task<string> ProcessIndicators(int indicatorIndex)
        {
               ...
               || HasMathType(indicatorIndex, MATH_TYPES.algorithm1, MATH_SUBTYPES.subalgorithm20))
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < dataURLs.Count(); i++)
                    {
                        //220: mathresults can hold 2 urls
        ...
        private async Task<string> ProcessAlgosAsync(int indicatorIndex, string dataURL)
        {
            ...
            lines = await GetDataLinesAsync(indicatorIndex, dataURL);
            if (lines != null)
            {
                //reset the data
        ...
        private async Task<string> ProcessAlgosAsync3(int indicatorIndex, string urls)
        {
                ...
                && indicatorIndex != 4)
            {
                ...
                lines = await GetDataLines(indicatorIndex, 0, urls);
                if (indicatorIndex == 6
                    || indicatorIndex == 7)
                {
                    //ind 5 has the costs
            ...
            else
            {
                ...
                else if (indicatorIndex == 4)
                {
                    ...
                    if (HasIndicatorData(indicatorIndex))
                    {
                        ...
                        lines3 = await GetDataLines(indicatorIndex, 0, urls);
        ...
        private async Task<string> ProcessAlgosAsync4(int indicatorIndex, string urls)
        {
            ...
            if (HasIndicatorData(indicatorIndex))
            {
                ...
                if (indicatorIndex == 5)
                {
                    lines2 = await GetDataLines(indicatorIndex, 1, urls);
                }
                else
                {
            ...
            string dataURL1, string dataURL2)
        {
            ...
            {
                //training dataset
                lines = await GetDataLinesAsync(indicatorIndex, dataURL1);
                //test dataset
                lines2 = await GetDataLinesAsync(indicatorIndex, dataURL2);
            }
            else if (HasMathType(indicatorIndex, MATH_TYPES.algorithm2)
                || HasMathType(indicatorIndex, MATH_TYPES.algorithm3)
                || HasMathType(indicatorIndex, MATH_TYPES.algorithm4))
            ...
            {
                //get the 1st dataset
                data = GetDataSetML(lines);
                //get the row identifiers from the test dataset
                colSet = CalculatorHelpers.GetColumnSetML(lines2, this);
                //if null already has an error message
                if (data != null)
                {
                    //get the 2nd dataset
                    data2 = GetDataSetML(lines2);
        ...
        public async Task<List<string>> GetDataLinesAsync(int indicatorIndex, string dataURL)
        {
            List<string> lines = new List<string>();
            lines = await CalculatorHelpers.ReadLines(CalcParameters.ExtensionDocToCalcURI, dataURL);
            if (lines == null)
            {
                CalculatorDescription += string.Concat(" Indicator ", indicatorIndex.ToString(), ": ", Errors.MakeStandardErrorMsg("DATAURL_BAD"));
                return null;
            }
            if (lines.Count == 0)
            {
        ...
        private async Task<List<string>> GetDataLines(int indicatorIndex, int dataSetIndex, string url)
        {
            List<string> lines = new List<string>();
            //semicolon delimiter
        ...
        private async Task<List<string>> GetMathResultLines(int indicatorIndex)
        {
            ...
            if (indicatorIndex == 0)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[0].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 1)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[1].IndMathResult);
                }
                else
                {
                    //get the csv lines out of mathresult and skip the first line
            ...
            else if (indicatorIndex == 2)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[2].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 3)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[3].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 4)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[4].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 5)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[5].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 6)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[6].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 7)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[7].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 8)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[8].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 9)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[9].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 10)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[10].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 11)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[11].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 12)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[12].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 13)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[13].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 14)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[14].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 15)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[15].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 16)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[16].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 17)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[17].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 18)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[18].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 19)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[19].IndMathResult);
                }
                else
                {
            ...
            else if (indicatorIndex == 20)
            {
                ...
                {
                    lines = await GetDataLinesAsync(indicatorIndex, ME2Indicators[20].IndMathResult);
                }
                else
                {
        ...
        public List<List<string>> GetDataSetML(List<string> lines)
        {
            //matrix of string
            List<List<string>> dataSet = new List<List<string>>();
            string rowName = string.Empty;
        ...
        private async Task <IDictionary<int, List<List<double>>>> GetDataSet1(int indicatorIndex, string dataURL)
        {
                ...
                && dataURL != Constants.NONE)
            {
                ...
                if (HasMathType(indicatorIndex, MATH_TYPES.algorithm1, MATH_SUBTYPES.subalgorithm2)
                    ...
                    || HasMathType(indicatorIndex, MATH_TYPES.algorithm1, MATH_SUBTYPES.subalgorithm4))
                {
                    dlines = await GetDataLinesAsync(indicatorIndex, dataURL);
                }
                if (dlines != null)
                {
                    //reset the data
            ...
            List<List<string>> colData, List<string> lines2)
        {
            ...
            if (HasMathType(index, MATH_TYPES.algorithm1, MATH_SUBTYPES.subalgorithm15)
                || HasMathType(index, MATH_TYPES.algorithm1, MATH_SUBTYPES.subalgorithm20))
            {
